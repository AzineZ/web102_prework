...
raisedCard.innerHTML = `<p>$${totalMoney.toLocaleString()}</p>`;
...
const displayStr = `
    A total of $${totalMoney.toLocaleString()} has been raised for ${totalGames} games. Currently, 
    ${unfundedGamesCount} games remains unfunded. We need your help to fund these
    amazing games!`;
